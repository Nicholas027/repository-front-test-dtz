...
const ProfessionalDetails = () => {
  ...
  const contactar = async (contactoProf, emailProf, nombreProf) => {
    Swal.fire({
      ...
      </svg> Celular: <b><a id="contactLink" href="https://api.whatsapp.com/send/?phone=${contactoProf}&text=Hola+${nombreProf}%2C+desearia+contactarme+con+vos+para+realizar+un+trabajo&type=phone_number&app_absent=0">Haz click aqui para contactar</a></b>`,
      showConfirmButton: false,
      showCancelButton: true,
      cancelButtonText: "Aceptar y Cerrar",
    });
